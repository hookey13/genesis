...
class DROrchestrator:
    ...
    def __init__(
        ...
        self.current_scenario: DRScenario | None = None
        self.dr_start_time: datetime | None = None
        self.dr_end_time: datetime | None = None
        ...
        self.last_readiness_check: datetime | None = None
