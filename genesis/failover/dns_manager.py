...
class DNSManager:
    ...
    def _get_headers(self) -> dict[str, str]:
        ...
        Returns:
            Request headers
        """
        if self.provider == "digitalocean" or self.provider == "cloudflare":
            return {
    ...
    async def get_records(self, domain: str, force_refresh: bool = False) -> list[DNSRecord]:
        ...
        try:
            ...
            logger.error("Failed to get DNS records", error=str(e))
            return []
    ...
    async def _get_cf_zone_id(self, domain: str) -> str | None:
    ...
    async def failover_dns(
        ...
        try:
            ...
            logger.error("DNS failover failed", error=str(e))
            return False
