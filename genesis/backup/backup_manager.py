...
class BackupManager:
    ...
    @with_retry(max_attempts=3, backoff_factor=2)
    async def create_incremental_backup(self) -> Optional[BackupMetadata]:
    ...
    ) -> Tuple[Optional[BackupMetadata], List[BackupMetadata]]:
    ...
    def _get_next_backup_time(self, backup_type: str) -> Optional[str]:
