...
class Contact:
    ...
    availability_hours: dict[str, str] | None = None  # {"start": "09:00", "end": "17:00"}
    timezone: str = "UTC"
    active: bool = True
    verified: bool = False
...
class OnCallRotation:
    ...
    override: str | None = None  # contact_id for temporary override
...
class ContactManager:
    ...
    def get_current_on_call(self, rotation_id: str) -> Contact | None:
    ...
    def get_next_on_call(self, rotation_id: str) -> Contact | None:
