...
class LogArchiveMetadata(BaseModel):
    ...
    start_timestamp: datetime | None = Field(None, description="First log entry timestamp")
    end_timestamp: datetime | None = Field(None, description="Last log entry timestamp")
    ...
    tier_level: str | None = Field(None, description="Tier level when archived")
...
class LogArchiver:
    ...
    async def _archive_file(self, file_path: Path) -> str | None:
        """
