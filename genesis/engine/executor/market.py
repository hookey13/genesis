...
from genesis.core.exceptions import OrderExecutionError, InsufficientBalance, SlippageAlert
...
class MarketOrderExecutor(OrderExecutor):
    ...
    async def execute_market_order(
        ...
        try:
            ...
            raise OrderExecutionError(
                f"Failed to execute market order: {str(e)}",
                order_id=order.order_id
            )
    ...
    async def cancel_all_orders(self, symbol: Optional[str] = None) -> int:
        ...
        try:
            ...
            raise OrderExecutionError(f"Emergency cancellation failed: {str(e)}")
    ...
    async def get_order_status(self, order_id: str, symbol: str) -> Order:
        ...
        try:
            ...
            raise OrderExecutionError(f"Failed to get order status: {str(e)}")