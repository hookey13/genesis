...
def test_settings_load_from_env(test_env):
    ...
    # Check exchange settings (use get_secret_value for SecretStr)
    assert settings.exchange.binance_api_key.get_secret_value() == "test_api_key"
    assert settings.exchange.binance_api_secret.get_secret_value() == "test_api_secret"
