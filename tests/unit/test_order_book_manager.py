...
class TestOrderBookLevel:
    ...
    def test_order_book_level_creation(self):
        ...
        level = OrderBookLevel(
            price=Decimal("50000.00"), quantity=Decimal("1.5"), order_count=3
        )
...
class TestOrderBookManager:
    ...
    def test_parse_depth_update(self, manager):
        ...
        data = {
            "lastUpdateId": 12345,
            "bids": [["50000.00", "1.5"], ["49999.00", "2.0"], ["49998.00", "1.0"]],
    ...
    def test_calculate_price_impact(self, manager):
        ...
        avg_price, impact = manager.calculate_price_impact(
            "BTCUSDT", "buy", Decimal("2.5")
        )
    ...
    async def test_heartbeat_loop(self, manager):
        ...
        manager.websocket_connections = {"BTCUSDT": mock_ws1, "ETHUSDT": mock_ws2}
