...
class TestReconciliationEngine:
    ...
    @pytest.mark.asyncio
    async def test_reconcile_balances_match(self, reconciliation_engine, mock_repo, mock_exchange, sample_account):
        ...
        mock_exchange.fetch_balance.return_value = {
            'USDT': {'free': float(exchange_balance), 'used': 0, 'total': float(exchange_balance)}
        }
        
        # Execute
        report = await reconciliation_engine.reconcile_balances(sample_account.account_id)
    ...
    @pytest.mark.asyncio
    async def test_reconcile_balances_discrepancy(self, reconciliation_engine, mock_repo, mock_exchange, sample_account):
    ...
    @pytest.mark.asyncio
    async def test_reconcile_positions_match(self, reconciliation_engine, mock_repo, mock_exchange, sample_account):
        ...
        # Execute
        report = await reconciliation_engine.reconcile_positions(sample_account.account_id)
    ...
    @pytest.mark.asyncio
    async def test_reconcile_positions_missing_in_exchange(self, reconciliation_engine, mock_repo, mock_exchange, sample_account):
        ...
        assert report.position_discrepancies[0].discrepancy_type == "MISSING_IN_EXCHANGE"
    
    @pytest.mark.asyncio
    async def test_reconcile_positions_size_mismatch(self, reconciliation_engine, mock_repo, mock_exchange, sample_account):
    ...
    @pytest.mark.asyncio
    async def test_month_end_reconciliation(self, reconciliation_engine, mock_repo, mock_exchange, sample_account):
    ...
    @pytest.mark.asyncio
    async def test_reconciliation_with_retry_on_failure(self, reconciliation_engine, mock_repo, mock_exchange, sample_account):
    ...
    @pytest.mark.asyncio
    async def test_reconciliation_alert_on_critical_discrepancy(self, reconciliation_engine, mock_repo, mock_exchange, sample_account):
    ...
    @pytest.mark.asyncio
    async def test_decimal_precision_preservation(self, reconciliation_engine, mock_repo, mock_exchange, sample_account):
        ...
        mock_repo.get_account_balance.return_value = db_balance
        mock_exchange.fetch_balance.return_value = {
            'USDT': {'free': exchange_balance_float, 'used': 0, 'total': exchange_balance_float}
        }
    ...
    @pytest.mark.asyncio
    async def test_multi_currency_reconciliation(self, reconciliation_engine, mock_repo, mock_exchange, sample_account):
        ...
        # Execute
        report = await reconciliation_engine.reconcile_all_balances(sample_account.account_id)
