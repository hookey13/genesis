...
class TestBinanceGateway:
    ...
    async def test_gateway_initialization_real_mode(self):
        ...
        mock_settings.exchange.binance_api_key.get_secret_value = MagicMock(return_value="test_api_key")
        mock_settings.exchange.binance_api_secret = MagicMock()
        mock_settings.exchange.binance_api_secret.get_secret_value = MagicMock(return_value="test_api_secret")
