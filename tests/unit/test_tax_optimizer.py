...
class TestTaxOptimizer:
    ...
    def test_year_end_tax_report_generation(self, tax_optimizer, sample_tax_lots):
        ...
        # Execute
        report = tax_optimizer.generate_year_end_report(
            year=2024,
            trades=trades
        )
    ...
    def test_tax_loss_harvesting(self, tax_optimizer):
        ...
        # Execute
        harvest_recommendations = tax_optimizer.identify_tax_loss_harvesting_opportunities(
            positions=positions,
    ...
    def test_multi_currency_tax_calculations(self, tax_optimizer):
        ...
        assert all(isinstance(v, Decimal) for v in portfolio_tax_summary.by_currency.values())
