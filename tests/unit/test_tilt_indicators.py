...
class TestPositionSizingIndicator:
    ...
    def test_risk_score_calculation(self, indicator):
        ...
        # Add risky pattern
        indicator.record_position(Decimal("1000"), datetime.now(UTC), "loss")
        indicator.record_position(Decimal("2000"), datetime.now(UTC), "loss")
        indicator.record_position(Decimal("4000"), datetime.now(UTC), "win")
