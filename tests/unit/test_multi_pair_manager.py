...
class TestMultiPairManager:
    ...
    @pytest.mark.asyncio
    async def test_initialize_loads_limits(self, manager, mock_repository, mock_state_manager):
    ...
    @pytest.mark.asyncio
    async def test_can_open_position_checks_global_limit(self, manager, mock_repository):
