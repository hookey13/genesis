...
from genesis.analytics.vwap_tracker import (
    VWAPTracker, Trade, VWAPMetrics, ExecutionPerformance
)
from genesis.core.models import Symbol, Side
...
class TestVWAPTracker:
    ...
    @pytest.mark.asyncio
    async def test_calculate_real_time_vwap_with_window(self, vwap_tracker, sample_trades):
