...
from genesis.analytics.kelly_sizing import KellyCalculator, VolatilityRegime
...
from genesis.core.models import Account, Trade, OrderSide, TradingSession
    ...
    async def test_end_to_end_workflow(self, test_account_strategist):
        ...
        for i in range(25):
            ...
            trade = Trade(
                ...
                timestamp=datetime.now(timezone.utc) - timedelta(days=25-i)
            )
