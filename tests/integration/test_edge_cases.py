...
class TestEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_simultaneous_buy_sell_signal_resolution(
        self, mock_repository, mock_exchange
    ):
    ...
    @pytest.mark.asyncio
    async def test_maximum_position_count_enforcement(
        self, mock_repository, risk_engine
    ):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_order_limit_enforcement(
        self, mock_exchange, mock_repository
    ):
