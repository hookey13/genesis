...
from genesis.engine.ab_test_framework import ABTestFramework, TestVariant
from genesis.engine.ab_test_framework import AllocationMethod as ABAllocationMethod
from genesis.engine.capital_allocator import AllocationMethod, CapitalAllocator
...
class TestMultiStrategyWorkflow:
    ...
    async def test_concurrent_strategy_execution(self, orchestrator):
        ...
        async def track_execution(strategy_id):
            ...
            execution_times[strategy_id] = datetime.now(UTC) - start
